...
* 2. Sending the message to be decrypted to the server.
...
int main(int argc, char *argv[]) {
  ...
  // Sending the message to the server chunk by chunk.
  while (count < text) {
  ...
  // Get decrypted message from server.
  count = 0;  
  ...
  // Retrieving the decrypted message from the server chunk by chunk
  while (count < text) {
