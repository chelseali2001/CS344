...
int main(int argc, char *argv[]){
  ...
  while(1){
    ...
    if (pid < 0) {
      ...
      // Check which client tried to connect.
      ...
      // If enc_client tries to connect to this server, return 'd' to show that enc_client tried to connect to the wrong server.
      if (client == 'e') {
        char actual = 'd';
      ...
      while (buffer[x] != '\n') {
        ...
        // Combining the key and message with modular arithemetic.
